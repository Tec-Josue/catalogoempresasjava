...
//el asterisco significa que vamos a importar todas las clases que estan en el paquete sql
...
public class ComunDB {
    ...
    static String connectionUrlSqlServer = "jdbc:sqlserver://localhost;"
            ...
            + "user=JavaUser;"
            + "password=#Modulo16;"
//            si en 30 segundos no selogra establecer la conexio con el servidor
